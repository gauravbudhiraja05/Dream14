#pragma checksum "D:\GitHub\Dream14\Dream14.WebAdmin\Views\SuperAdmin\EventDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9c7ccdeb50e808c38a42bf81052e33d4887be4fb"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9c7ccdeb50e808c38a42bf81052e33d4887be4fb", @"/Views/SuperAdmin/EventDetail.cshtml")]
...
<style type=""text/css"">
    ...
    ");
            EndContext();
            BeginContext(4737, 195, true);
            WriteLiteral("@-webkit-keyframes animatetop {\r\n        from {\r\n            top: -300px;\r\n            opacity: 0\r\n        }\r\n\r\n        to {\r\n            top: 0;\r\n            opacity: 1\r\n        }\r\n    }\r\n\r\n    ");
            EndContext();
            BeginContext(4933, 1033, true);
...
<div class=""tab_menu"">
    <div class=""center_wrap"">
        <button type=""button"" class=""");
            WriteLiteral("back_btn\"");
            EndContext();
            BeginWriteAttribute("onClick", " onClick=\"", 5966, "\"", 6036, 3);
            WriteAttributeValue("", 5976, "window.location.href=\'", 5976, 22, true);
#line 263 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\SuperAdmin\EventDetail.cshtml"
WriteAttributeValue("", 5998, Url.Action("EventList","SuperAdmin"), 5998, 37, false);

#line default
#line hidden
            WriteAttributeValue("", 6035, "\'", 6035, 1, true);
            EndWriteAttribute();
            BeginContext(6037, 36718, true);
...
<div id=""bookMakerModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        ...
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                We will simply compare both teams 10 overs higher score tea");
            WriteLiteral(@"m will be declared winner in T20 matches (10 over comparison)
            </label>
            <label class=""red-color"">
...
<div id=""sessionMarketModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        ...
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                3. In case technical error or");
            WriteLiteral(@" any circumstances any fancy is suspended and does not resume result will be given all previous bets will be valid (based on haar/jeet).
            </label>
            <label class=""red-color"">
      ...
      ");
            ...
            <label class=""red-color"">
                11. Company reserves the right to void any bets (only winning bets) of any event at any point of the match if the company believes there is an");
            WriteLiteral(@"y cheating/wrong doing in that particular event by the players (either batsman/bowler)
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
");
            WriteLiteral(@"                15.Traders will be block the user ID if find any misinterpret activities, No queries accept regarding.
            </label>
            <label class=""red-color"">
            ...
            <label>
                1.4 1");
            WriteLiteral(@"st day 2nd session run minimum 25 over will be played then result is given otherwise 1st day 2nd session will be deleted.
            </label>
            <label>
     ...
     ");
            ...
            <label>
                Complete session is valid in case due to rain or match abandoned pa");
            WriteLiteral(@"rticular session will be deleted.
            </label>
            <label>
            ...
            <label>
                If o");
            WriteLiteral(@"ver reduced due to rain or weather condition or match abandoned the result will be given as per score.
            </label>
            <label class=""red-color"">
                Other fancy:-
            </label>
            ...
            <label>
                1st wicket lost to any team balls meaning that any team 1st wicket fall down in how many balls that particular fancy a");
            WriteLiteral(@"t least minimum one ball have to be played otherwise bets will be deleted.
            </label>
            <label>
      ...
      ");
            ...
            <label>
                1. All bets will be considered as valid if a player has been replaced under concussion substitute, result will be");
            WriteLiteral(@" given for the runs scored by the mentioned player. For example DM Bravo gets retired hurt at 23 runs, then result will be given for 23.
            </label>
            <label>
            ...
            <label>
                This event will be considered valid only if the number of overs defined on the particular event has been bowled, otherwise all bets related to this event will get void. For example 0-25 ove");
            WriteLiteral(@"r events will be valid only if 25 overs has been bowled, else the same will not be considered as valid
            </label>
            <label>
            ...
            <label>
                The mentioned bowler has to complete the defined number of overs, else the bets related to that particular event will get ");
            WriteLiteral(@"void. For example if the mentioned bowler has bowled 8 overs, then 5 over run of that particular bowler will be considered as valid and the 10 over run will get void
            </label>
            <label class=""red-color"">
            ...
            <label>
                This events will be valid only if the defined number of over is completed. For example team batting first gets all out in 29.4 over then the same will be considered ");
            WriteLiteral(@"as 30 over, the team batting second must complete 20 overs only then 0-50 over events will be considered as valid. In case team batting second gets all out in 19.4 over then 0-50 over event will not be considered as valid, This same is valid for 1st Innings only.
            </label>
            <label class=""red-color"">
                Bowler event- ODI:-
            </label>
            ...
            <label>
                Bowler Session: This event is valid only if the bowler has completed his maximum quota of overs, else the same will be voided. However if the match has resulted and the particular bowler ha");
            WriteLiteral(@"s already started bowling his final over then result will be given even if he haven't completed the over. For example B Kumar is bowling his final over and at 3.4 the match has resulted then result will be given for B Kumar over runs
            </label>
            <label>
            ...
            <label>
                Bets will be deleted if there is no Free hit in the mentioned ma");
            WriteLiteral(@"tch
            </label>
            <label>
            ...
            <label>
                In case of any technical issues the video gets interrupted/sto");
            WriteLiteral(@"pped and the same cannot be continued, the existing markets will be voided. However the markets which are already finished/settled will remain valid.
            </label>
            <label class=""red-color"">
                CPL:-
            </label>
            ...
            <label>
                Total sixes: Average 13 sixes will be given in case match abandoned or o");
            WriteLiteral(@"ver reduced
            </label>
            <label>
            ...
            WriteLiteral(@"based on the rates given for the same, then the particular result will be considered valid, similarly if the tournament gets canceled due to any reason the previously given result will be considered valid
            </label>
            <label>
            ...
            <label>
                Highest Sixes in individual match: Bot");
            WriteLiteral(@"h innings are valid
            </label>
            <label>
...
<div id=""fancy1MarketModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""popu");
            WriteLiteral(@"p_close_btn fancy1MarketClose""></span>
            <h3>Rules</h3>
...
");
            EndContext();
            BeginContext(52753, 91, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6cc58286f21a4eef95b09ee08b517420", async() => {
            }
            );
...
#line 1179 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\SuperAdmin\EventDetail.cshtml"
