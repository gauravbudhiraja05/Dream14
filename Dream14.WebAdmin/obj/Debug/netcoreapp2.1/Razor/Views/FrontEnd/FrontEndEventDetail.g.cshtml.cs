#pragma checksum "D:\GitHub\Dream14\Dream14.WebAdmin\Views\FrontEnd\FrontEndEventDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "30d45b55fce584306f233450f7c29f62633b468e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"30d45b55fce584306f233450f7c29f62633b468e", @"/Views/FrontEnd/FrontEndEventDetail.cshtml")]
...
#line default
#line hidden
            BeginContext(109, 39560, true);
            WriteLiteral(@"

<style>

    .transpaprent-background {
...
<div id=""bookMakerModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""close bookmakerClose"">&times;</span>
            <h3>Rules</h3>
            <div class=""sub-header"">Bookmaker</div>
        </div>
        <div class=""modal-body"">
            <label");
            WriteLiteral(@" class=""red-color"">
            ...
            <label class=""red-color"">
                Any query about the result or rates should be contacted within 7 days of the specific ev");
            WriteLiteral(@"ent, the same will not be considered valid post 7 days from the event.
            </label>
            <label class=""red-color"">
...
<div id=""sessionMarketModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        ...
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                4. If any case");
            WriteLiteral(@" wrong rate has been given in fancy that particular bets will be cancelled.
            </label>
            <label class=""red-color"">
            ...
            <la");
            WriteLiteral(@"bel class=""red-color"">
            ...
            <label class=""red-color"">
                12. Once our exchange give username and password it is your resp");
            WriteLiteral(@"onsibility to change a password.
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                16. Our exchange is not responsi");
            WriteLiteral(@"ble for misuse of client id.
            </label>
            <label class=""red-color"">
                Test
            </label>
            ...
            <label>
                1.5 1st day total run minimum 80 over will be p");
            WriteLiteral(@"layed then result is given otherwise 1st day total run will be deleted.
            </label>
            <label>
            ...
            <label>
                4.2 Partnership and player runs due to weather condition or match abandoned th");
            WriteLiteral(@"e result will be given as per score.
            </label>
            <label>
            ...
            <label>
                Match 1st");
            WriteLiteral(@" over run advance fancy only 1st innings run will be counted.
            </label>
            <label>
    ...
    ");
           ...
           ");
            ...
            <label>
                For example :- 15 over run team a is playing any case team a is all-out in 13 over team A has made 100 run the session result is valida");
            WriteLiteral(@"ted on particular run.
            </label>
            <label>
                Advance session is valid in only 1st innings.
            </label>
            ...
            <label>
                In advance fancy opening batsmen is only valid if same batsmen came in opening the fancy will be valid in case one batsmen is changed that particular player fan");
            WriteLiteral(@"cy will be deleted.
            </label>
            <label class=""red-color"">
          ...
          ");
            ...
            <label>
                2. Bets of both the player will ");
            WriteLiteral(@"be valid under concussion substitute.
            </label>
            <label class=""red-color"">
            ...
            <label>
                If the team gets all out prior to any of the defined overs, then b");
            WriteLiteral(@"alance overs will be counted in next innings. For example if the team gets all out in 23.1 over the same will be considered as 24 overs and the balance overs will be counted from next innings.
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
 ");
            WriteLiteral(@"               Player ball event's- Test:-
            </label>
            <label>
            ...
            <label>
                This events will be valid only if the defined number of over is completed. For example team batting first gets all out in 29.4 over then the same will be considered as 30 over, the team batting second must complete 20 overs only then 0-50 over events will be considered as valid. In case team batting second gets all out in 19.4 over then 0-50 over event will not be considered as valid, This s");
            WriteLiteral(@"ame is valid for 1st Innings only.
            </label>
            <label class=""red-color"">
                Bowler event- ODI:-
            </label>
            ...
            <label>
                The events for 1-10 over and 11-20 over will be considered valid only if the number of over mentioned has been played completely. However if the over got reduced before the particular event then the same will be voided, if the team batting first get all out prior to 20 over the balance over will be coun");
            WriteLiteral(@"ted from second innings. For example if team batting first gets all out in 17 over balance 3 over will be counted from second innings. This same is valid for 1st Innings only.
            </label>
            <label>
            ...
            <label>
                Total Wi");
            WriteLiteral(@"des - Average 10 wides will be given in case match abandoned or over reduced
            </label>
            <label>
 ...
 ");
            ...
            <label>
                Highest Wicket in individual m");
            WriteLiteral(@"atch: Both innings are valid
            </label>
            <label>
            ...
            <label>
                First 6");
            WriteLiteral(@" over run: Average 43 run will be given in case match abandoned or over reduced
            </label>
            <label class=""red-color"">
                Jamaica Tallawahs
            </label>
...
<div id=""betModal"" class=""modal"">
    <div class=""modal-content transpaprent-background"" style=""width:60%; height:50%"">
        <div class=""modal-header"">
            <span class=""close betClose"">&times;</span>
            <h3>Change Bet Value</h3>
        </div>
        <div class=""m");
            WriteLiteral(@"odal-body"">
            <table>
                <tr class=""transpaprent-background"">
                    <th class=""transpaprent-background"">(Bet for)</th>
                    <th class=""transpaprent-background"">Odds</th>
                    <th class=""transpaprent-background"">Stake</th>
                    <th class=""transpaprent-background"">Profit</th>
                </tr>
                <tr class=""transpaprent-background"">
                    <td>
                        <input type=""text"" class=""txt-new"" id=""txtTeamName"" style=""background-color: #ffffff;"" disabled />
                    </td>
                    <td>
                        <input type=""text"" class=""txt-new"" id=""txtBetValue"" />
                    </td>
                    <td>
                        <input type=""text"" class=""txt-new"" id=""txtStakeValue"" />
                    </td>
                    <td>
                        <input type=""text"" class=""txt-new"" id=""txtProfit"" style=""background-color: #ffffff;"" dis");
            WriteLiteral(@"abled />
                    </td>
                </tr>
                <tr class=""transpaprent-background"">
                    <td colspan=""4"">
                        <button class=""btn_field btn-new"" id=""btn_bet1""></button>
                        <button class=""btn_field btn-new"" id=""btn_bet2""></button>
                        <button class=""btn_field btn-new"" id=""btn_bet3""></button>
                        <button class=""btn_field btn-new"" id=""btn_bet4""></button>
                        <button class=""btn_field btn-new"" id=""btn_bet5""></button>
                    </td>
                </tr>
                <tr class=""transpaprent-background"">
                    <td colspan=""4"">
                        <button class=""btn_field btn-new"" id=""btn_bet6""></button>
                        <button class=""btn_field btn-new"" id=""btn_bet7""></button>
                        <button class=""btn_field btn-new"" id=""btn_bet8""></button>
                        <button class=""btn_field btn-new"" id=""btn_");
            WriteLiteral(@"bet9""></button>
                        <button class=""btn_field btn-new"" id=""btn_bet10""></button>
                    </td>
                </tr>
                <tr class=""transpaprent-background"">
                    <td colspan=""2"">
                        <button id=""btnResetBet"" class=""btn_danger"">Reset</button>
                    </td>
                    <td colspan=""2"">
                        <button id=""btnSaveBet"" class=""btn_Submit"">Submit</button>
                    </td>
                </tr>
            </table>
        </div>
...
");
            EndContext();
            BeginContext(52665, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1bd8c2f68bbc40888b4e8572e654aca6", async() => {
            }
            );
