#pragma checksum "D:\GitHub\Dream14\Dream14.WebAdmin\Views\FrontEnd\FrontEndEventDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f5d0c18d2f0bf1046b8196d57e8707248ee1be5"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f5d0c18d2f0bf1046b8196d57e8707248ee1be5", @"/Views/FrontEnd/FrontEndEventDetail.cshtml")]
...
<table class=""table-css1"">
    <tr>
        ...
        <th id=""th2_header""></th>
");
            WriteLiteral(@"        <th id=""th3_header""></th>
    </tr>
</table>
<div>
...
<div id=""bookMakerModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""");
            WriteLiteral(@"close bookmakerClose"">&times;</span>
            <h3>Rules</h3>
        ...
        <div class=""modal-body"">
            ...
            WriteLiteral(@"(10 over comparison)
            </label>
            <label class=""red-color"">
            ...
            <label>
                At any situation if the vide");
            WriteLiteral(@"o gets interrupted/stopped then the same cannot be continued due to any technical issues bookmaker market will be voided
            </label>
...
<div id=""sessionMarketModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        ...
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                3. In case technical error or any circumstances any fancy is suspended ");
            WriteLiteral(@"and does not resume result will be given all previous bets will be valid (based on haar/jeet).
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                8. Manual bets are not accepted ");
            WriteLiteral(@"in our exchange
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                11. Company reserves the right to void any bets (only winning bets) of any event at any point of the match if the company believes there is any cheating/wrong doing in that particular ");
            WriteLiteral(@"event by the players (either batsman/bowler)
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                15.Traders will be block t");
            WriteLiteral(@"he user ID if find any misinterpret activities, No queries accept regarding.
            </label>
            <label class=""red-color"">
            ...
            <label>
                1.4 1st day 2nd session run minimum 25 over wil");
            WriteLiteral(@"l be played then result is given otherwise 1st day 2nd session will be deleted.
            </label>
            <label>
            ...
            <label>
                4.1 In partnership one batsman is i");
            WriteLiteral(@"njured partnership is continued in next batsman.
            </label>
            <label>
    ...
    ");
            ...
            WriteLiteral(@"players are different or same.
            </label>
            <label>
       ...
       ");
          ...
          ");
            ...
            <label>
                If over reduced due to rain or weather conditi");
            WriteLiteral(@"on or match abandoned the result will be given as per score.
            </label>
            <label class=""red-color"">
                Other fancy:-
            </label>
            ...
            <label>
                1st wicket lost to any team balls meaning that any team 1st wicket fall down in how many balls that particular fancy at least minimum one ball have to be played");
            WriteLiteral(@" otherwise bets will be deleted.
            </label>
            <label>
            ...
            <label>
                How many ba");
            WriteLiteral(@"lls face any batsman meaning that any batsman how many balls he/she played that particular fancy at least one ball have to be played otherwise that fancy bets will be deleted.
            </label>
            <label>
            ...
            <label>
                1. All bets will be considered as valid if a player has been replaced under concussion substitute, result will be given for the runs scored by the mentione");
            WriteLiteral(@"d player. For example DM Bravo gets retired hurt at 23 runs, then result will be given for 23.
            </label>
            <label>
            ...
            <label>
                This event will be considered valid only if the number of overs defined on the particular event has been bowled, otherwise all bets related to this event will get void. For example 0-25 over events will be valid only if 25 overs ha");
            WriteLiteral(@"s been bowled, else the same will not be considered as valid
            </label>
            <label>
            ...
            <label>
                The mentioned bowler has to complete the defined number of overs, else the bets related to that particular event will get void. For example if the mentioned bowler ");
            WriteLiteral(@"has bowled 8 overs, then 5 over run of that particular bowler will be considered as valid and the 10 over run will get void
            </label>
            <label class=""red-color"">
            ...
            <label>
                This events will be valid only if the defined number of over is completed. For example team batting first gets all out in 29.4 over then the same will be considered as 30 over, the team batting second must c");
            WriteLiteral(@"omplete 20 overs only then 0-50 over events will be considered as valid. In case team batting second gets all out in 19.4 over then 0-50 over event will not be considered as valid, This same is valid for 1st Innings only.
            </label>
            <label class=""red-color"">
                Bowler event- ODI:-
            </label>
            ...
            <label>
                Bowler Session: This event is valid only if the bowler has completed his maximum quota of overs, else the same will be voided. However if the match has resulted and the particular bowler has already started bowling his final over t");
            WriteLiteral(@"hen result will be given even if he haven't completed the over. For example B Kumar is bowling his final over and at 3.4 the match has resulted then result will be given for B Kumar over runs
            </label>
            <label>
            ...
            <label>
                In case of any technical issues the video gets interrupted/stopped and the same cannot be continued, the");
            WriteLiteral(@" existing markets will be voided. However the markets which are already finished/settled will remain valid.
            </label>
            <label class=""red-color"">
                CPL:-
            </label>
       ...
       ");
            ...
            <label>
                At any situation if result is given for any particular event based on the rates given for the same, the");
            WriteLiteral(@"n the particular result will be considered valid, similarly if the tournament gets canceled due to any reason the previously given result will be considered valid
            </label>
            <label>
...
");
            EndContext();
            BeginContext(48828, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b69c3a2a03b849e0be5b0c6429891f98", async() => {
            }
            );
