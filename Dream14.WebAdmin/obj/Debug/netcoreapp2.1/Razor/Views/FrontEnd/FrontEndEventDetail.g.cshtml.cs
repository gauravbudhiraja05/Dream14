#pragma checksum "D:\GitHub\Dream14\Dream14.WebAdmin\Views\FrontEnd\FrontEndEventDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4e0c8d2b742ca5e89a3c8421e24d14b3fb8ef2df"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_FrontEnd_FrontEndEventDetail), @"mvc.1.0.view", @"/Views/FrontEnd/FrontEndEventDetail.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/FrontEnd/FrontEndEventDetail.cshtml", typeof(AspNetCore.Views_FrontEnd_FrontEndEventDetail))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4e0c8d2b742ca5e89a3c8421e24d14b3fb8ef2df", @"/Views/FrontEnd/FrontEndEventDetail.cshtml")]
    ...
    public class Views_FrontEnd_FrontEndEventDetail : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_0 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("src", new global::Microsoft.AspNetCore.Html.HtmlString("~/js/FrontEnd/frontend.eventDetail.js"), global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        #line hidden
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 2 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\FrontEnd\FrontEndEventDetail.cshtml"
  
    ViewData["Title"] = "FrontEndEventDetail";
    Layout = "~/Views/Shared/_InnerLayout.cshtml";

#line default
#line hidden
            BeginContext(109, 38726, true);
            WriteLiteral(@"
...
<div id=""matchOddsModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""close matchOddsClose"">&times;</span>
            <h3>Rules</h3>
...
<div id=""bookMakerModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span clas");
            WriteLiteral(@"s=""close bookmakerClose"">&times;</span>
            <h3>Rules</h3>
        ...
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                We will simply compare both teams 10 overs higher score team will be declared winner in T20 match");
            WriteLiteral(@"es (10 over comparison)
            </label>
            <label class=""red-color"">
            ...
            <label>
                At any situation if the v");
            WriteLiteral(@"ideo gets interrupted/stopped then the same cannot be continued due to any technical issues bookmaker market will be voided
            </label>
...
<div id=""sessionMarketModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""close sessionMarketClose"">&times;</span>
            <h3>Rules</h3>
        ...
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                3. In case technical error or any circumstances any fancy is suspend");
            WriteLiteral(@"ed and does not resume result will be given all previous bets will be valid (based on haar/jeet).
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                8. Manual bets are not accept");
            WriteLiteral(@"ed in our exchange
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                11. Company reserves the right to void any bets (only winning bets) of any event at any point of the match if the company believes there is any cheating/wrong doing in that particul");
            WriteLiteral(@"ar event by the players (either batsman/bowler)
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                15.Traders will be bloc");
            WriteLiteral(@"k the user ID if find any misinterpret activities, No queries accept regarding.
            </label>
            <label class=""red-color"">
            ...
            WriteLiteral(@"will be played then result is given otherwise 1st day 2nd session will be deleted.
            </label>
            <label>
            ...
            <label>
                4.1 In partnership one batsman i");
            WriteLiteral(@"s injured partnership is continued in next batsman.
            </label>
            <label>
            ...
            <label>
 ");
            WriteLiteral(@"               Advance 50 over runs is valid in only 1st innings.
            </label>
            <label class=""red-color"">
                Odi batsman runs:-
            </label>
            ...
            <label>
                Advance partnership is valid in case bo");
            WriteLiteral(@"th players are different or same.
            </label>
            <label>
    ...
    ");
       ...
       ");
            ...
            <label>
                If over reduced due to rain or weather cond");
            WriteLiteral(@"ition or match abandoned the result will be given as per score.
            </label>
            <label class=""red-color"">
                Other fancy:-
            </label>
            ...
            <label>
                1st wicket lost to any team balls meaning that any team 1st wicket fall down in how many balls that particular fancy at least minimum one ball have to be pla");
            WriteLiteral(@"yed otherwise bets will be deleted.
            </label>
            <label>
            ...
            <label>
                How many");
            WriteLiteral(@" balls face any batsman meaning that any batsman how many balls he/she played that particular fancy at least one ball have to be played otherwise that fancy bets will be deleted.
            </label>
            <label>
            ...
            <label>
                1. All bets will be considered as valid if a player has been replaced under concussion substitute, result will be given for the runs scored by the menti");
            WriteLiteral(@"oned player. For example DM Bravo gets retired hurt at 23 runs, then result will be given for 23.
            </label>
            <label>
            ...
            <label>
                This event will be considered valid only if the number of overs defined on the particular event has been bowled, otherwise all bets related to this event will get void. For example 0-25 over events will be valid only if 25 overs");
            WriteLiteral(@" has been bowled, else the same will not be considered as valid
            </label>
            <label>
            ...
            <label>
                The mentioned bowler has to complete the defined number of overs, else the bets related to that particular event will get void. For example if the mentioned bowl");
            WriteLiteral(@"er has bowled 8 overs, then 5 over run of that particular bowler will be considered as valid and the 10 over run will get void
            </label>
            <label class=""red-color"">
            ...
            <label>
                This events will be valid only if the defined number of over is completed. For example team batting first gets all out in 29.4 over then the same will be considered as 30 over, the team batting second mus");
            WriteLiteral(@"t complete 20 overs only then 0-50 over events will be considered as valid. In case team batting second gets all out in 19.4 over then 0-50 over event will not be considered as valid, This same is valid for 1st Innings only.
            </label>
            <label class=""red-color"">
                Bowler event- ODI:-
            </label>
            ...
            <label>
                Bowler Session: This event is valid only if the bowler has completed his maximum quota of overs, else the same will be voided. However if the match has resulted and the particular bowler has already started bowling his final ove");
            WriteLiteral(@"r then result will be given even if he haven't completed the over. For example B Kumar is bowling his final over and at 3.4 the match has resulted then result will be given for B Kumar over runs
            </label>
            <label>
            ...
            <label>
                In case of any technical issues the video gets interrupted/stopped and the same cannot be continued, ");
            WriteLiteral(@"the existing markets will be voided. However the markets which are already finished/settled will remain valid.
            </label>
            <label class=""red-color"">
                CPL:-
            </label>
    ...
    ");
            ...
            <label>
                At any situation if result is given for any particular event based on the rates given for the same, ");
            WriteLiteral(@"then the particular result will be considered valid, similarly if the tournament gets canceled due to any reason the previously given result will be considered valid
            </label>
            <label>
            ...
            <label>
          ");
            WriteLiteral(@"      First 6 over run: Average 45 run will be given in case match abandoned or over reduced
            </label>
            <label class=""red-color"">
...
<div id=""fancy1MarketModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""close fancy1MarketClose"">&times;</span>
");
            WriteLiteral(@"            <h3>Rules</h3>
...
");
            EndContext();
            BeginContext(48831, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a0cd656c2b294119af6e4c527a2f0106", async() => {
            }
            );
