#pragma checksum "D:\GitHub\Dream14\Dream14.WebAdmin\Views\FrontEnd\FrontEndEventDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6124adf02d2af701e3348d222ef3201a117995e4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6124adf02d2af701e3348d222ef3201a117995e4", @"/Views/FrontEnd/FrontEndEventDetail.cshtml")]
...
");
            EndContext();
            BeginContext(2193, 276, true);
            WriteLiteral(@"<table class=""table-css"">
    <tr>
        <th id=""th1_header""></th>
        <th id=""th2_header""></th>
        <th id=""th3_header""></th>
...
");
            ...
            WriteLiteral("        <table class=\"table-css\" id=\"Table_t3\"></table>\r\n");
            EndContext();
            BeginContext(2726, 57, true);
            WriteLiteral("        <table class=\"table-css\" id=\"Table_t4\"></table>\r\n");
            EndContext();
            BeginContext(2799, 35333, true);
            WriteLiteral(@"</div>
...
<div id=""bookMakerModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        ...
        <div class=""modal-body"">
            ...
            WriteLiteral(@"we are not concerned.
            </label>
            <label class=""red-color"">
...
<!-- The Modal -->
<div id=""sessionMarketModal"" class=""m");
            WriteLiteral(@"odal"">
    ...
    <div class=""modal-content"">
        ...
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                13. Pena");
            WriteLiteral(@"lty runs will not be counted in any fancy.
            </label>
            <label class=""red-color"">
      ...
      ");
            ...
            <label>
   ");
            WriteLiteral(@"             1.6 Test match both advance session is valid.
            </label>
            <label class=""red-color"">
            ...
            <label>
                3.2 Batsman 50/100 run if batsman is injured or declaration the result will be gi");
            WriteLiteral(@"ven on particular run.
            </label>
            <label>
            ...
            <label>
                4.3 Advance partnershi");
            WriteLiteral(@"p is valid in case both players are different or same.
            </label>
            <label>
            ...
            <label>
             ");
            WriteLiteral(@"   Complete session is valid in case due to rain or match abandoned particular session will be deleted.
            </label>
            <label>
 ...
 ");
            ...
            <label>
                F");
            WriteLiteral(@"our, sixes, wide, wicket, extra run, total run, highest over ,top batsman,maiden over,caught-out,no-ball,run-out,fifty and century are valid only match has been completed in case due to rain over has been reduced all other fancy will be deleted.
            </label>
            <label class=""red-color"">
                T20:-
            </label>
            ...
            <label>
                T-20 ,one day and test match in case current innings player and partnership are running in be");
            WriteLiteral(@"tween match has been called off or abandoned that situation all current player and partnership results are valid.
            </label>
            <label>
            ...
            <label>
                How many balls for 50 runs any team meaning that any team achieved 50 runs in how many balls that p");
            WriteLiteral(@"articular fancy at least one ball have to be played otherwise that fancy bets will be deleted.
            </label>
            <label>
            ...
            <label class=""red-color"">
                Tot");
            WriteLiteral(@"al Match- Events (test):-
            </label>
            <label>
            ...
            <label>
                If the team gets all out prior to any of the defined overs, then balance overs will be counted in next innings. For example if the team gets all out in 23.1 over the same will be consid");
            WriteLiteral(@"ered as 24 overs and the balance overs will be counted from next innings.
            </label>
            <label class=""red-color"">
            ...
            <label>
                This event will ");
            WriteLiteral(@"be considered valid only if the defined number of runs made by the mentioned player, else the result will be considered as 0 (zero) balls
            </label>
            <label>
            ...
            WriteLiteral(@"second innings. This same is valid for 1st Innings only.
            </label>
            <label>
            ...
            <label>
                Incase of DLS, the over got reduced then the bowler wh");
            WriteLiteral(@"o has already bowled his maximum quota of over that result will be considered as valid and the rest will be voided
            </label>
            <label class=""red-color"">
            ...
            <label>
                If CPL fixture 0f 33 matches gets reduced due to any r");
            WriteLiteral(@"eason, then all the special fancies will be voided (Match abandoned due to rain/bad light will not be considered in this)
            </label>
            <label>
            ...
            <label>
     ");
            WriteLiteral(@"           Highest innings run - Only first innings is valid
            </label>
            <label>
            ...
            <label>
                Super over will not be include");
            WriteLiteral(@"d
            </label>
            <label class=""red-color"">
                Barbados Tridents
            ...
            <label>
                Opening partnership run: Average 22 runs will be given ");
            WriteLiteral(@"in case match abandoned or over reduced
            </label>
            <label>
            ...
            <lab");
            WriteLiteral(@"el class=""red-color"">
                Jamaica Tallawahs
            </label>
            <label>
                Opening partnership run: Average 24 runs will be given in case match abandoned or over reduced
...
<div id=""fancy1MarketModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        ...
        <div class=""modal-body"">
            ...
            <label>
                1.");
            WriteLiteral(@"1 Completed game is valid , in case due to rain over are reduced or match abandoned particular game will be deleted.
            </label>
            <label>
            ...
            <label class=""red-color"">
                2.1 If any player does not come as per playing eleven then all ");
            WriteLiteral(@"bets will be get deleted for the particular player.
            </label>
            <label>
...
");
            EndContext();
            BeginContext(48128, 61, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "788be37998c34a1d83f5ff3b8a9d9bc1", async() => {
            }
            );
