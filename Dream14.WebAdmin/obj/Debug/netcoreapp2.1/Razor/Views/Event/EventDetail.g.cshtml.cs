#pragma checksum "D:\GitHub\Dream14\Dream14.WebAdmin\Views\Event\EventDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d513f3f547d203570ba3b233c1a02710addaa009"
// <auto-generated/>
...
#line default
#line hidden
#line 1 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\Event\EventDetail.cshtml"
using System.Security.Claims;

#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d513f3f547d203570ba3b233c1a02710addaa009", @"/Views/Event/EventDetail.cshtml")]
    ...
    {
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_0 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("src", "~/js/Event/event.eventDetail.js", global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        #line hidden
        ...
        {
#line 3 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\Event\EventDetail.cshtml"
  
    string roleName = HttpContextAccessor.HttpContext.User.Claims?.Where(c => c.Type == ClaimTypes.Role).Select(r => r.Value).FirstOrDefault();
...
#line hidden
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 8 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\Event\EventDetail.cshtml"
...
<style>
    ...
    .edit_item1 {
        ...
        height: 20px;
        border-radius: 50%;
        background: #455a64 url(../images/table_edit_w.png) center center no-repeat;
...
<style type=""text/css"">
    ...
    .popup_close_btn {
        ...
        height: ");
            WriteLiteral(@"35px;
        border-radius: 50%;
        background: #ff5c6c url(../images/close_btn2.png) center center no-repeat;
        float: right;
        position: absolute;
        right: 20px;
        top: 26px;
    ...
    .modal-content {
        ...
        box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2),");
            WriteLiteral("0 6px 20px 0 rgba(0,0,0,0.19);\r\n        -webkit-animation-name: animatetop;\r\n        -webkit-animation-duration: 0.4s;\r\n        animation-name: animatetop;\r\n        animation-duration: 0.4s\r\n    }\r\n\r\n    /* Add Animation */\r\n    ");
            EndContext();
            BeginContext(5708, 195, true);
            WriteLiteral("@-webkit-keyframes animatetop {\r\n        from {\r\n            top: -300px;\r\n            opacity: 0\r\n        }\r\n\r\n        to {\r\n            top: 0;\r\n            opacity: 1\r\n        }\r\n    }\r\n\r\n    ");
            EndContext();
            BeginContext(5904, 1235, true);
    ...
    .btn-danger {");
            ...
            EndContext();
            BeginWriteAttribute("value", " value=\"", 7139, "\"", 7156, 1);
#line 312 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\Event\EventDetail.cshtml"
WriteAttributeValue("", 7147, roleName, 7147, 9, false);

#line default
#line hidden
            EndWriteAttribute();
            BeginContext(7157, 106, true);
            WriteLiteral(" />\r\n<div class=\"tab_menu\">\r\n    <div class=\"center_wrap\">\r\n        <button type=\"button\" class=\"back_btn\"");
            EndContext();
            BeginWriteAttribute("onClick", " onClick=\"", 7263, "\"", 7333, 3);
            WriteAttributeValue("", 7273, "window.location.href=\'", 7273, 22, true);
#line 315 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\Event\EventDetail.cshtml"
WriteAttributeValue("", 7295, Url.Action("EventList","SuperAdmin"), 7295, 37, false);

#line default
#line hidden
            WriteAttributeValue("", 7332, "\'", 7332, 1, true);
            EndWriteAttribute();
            BeginContext(7334, 36720, true);
            ...
            <div class=""form_wrap"">
                ...
                <div class=""tab_content"" id=""tab_1"">
                    ...
                    <div>
                        ...
                        <table class=""");
            WriteLiteral(@"table-css"" id=""Table_t3""></table>
                        <table class=""table-css"" id=""Table_t4""></table>
                    </div>
...
<!-- The MatchOddsModal -->
<div id=""matchOddsModal"" class=""modal"">
    <!-- Modal content -->
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""popup_close_btn matchOddsClose""></span>
            <h3>Rules</h3>
            <div class=""sub-header"">Match</div>
        </div>
...
<div id=""bookMakerModal"" class=""modal"">
    ...
    <div class=""modal-content"">
        <div class=""m");
            ...
            <span class=""popup_close_btn bookmakerClose""></span>
            <h3>Rules</h3>
            <div class=""sub-header"">Bookmaker</div>
        </div>
        <div class=""modal-body"">
            ...
            <label class=""red-color"">
                We will simply compare both teams 10 overs higher score t");
            WriteLiteral(@"eam will be declared winner in T20 matches (10 over comparison)
            </label>
            <label class=""red-color"">
            ...
            <label>
 ");
            WriteLiteral(@"               At any situation if the video gets interrupted/stopped then the same cannot be continued due to any technical issues bookmaker market will be voided
            </label>
...
<!-- The SessionMarketModal -->
<div id=""sessionMarketModal"" class=""modal"">
    <!-- Modal content -->
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""popup_close_btn sessionMarketClose""></span>
            <h3>Rules</h3>
            <div class=""sub-header"">Fancy</div>
        </div>
        <div class=""modal-body"">
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                3. In case technical error ");
            WriteLiteral(@"or any circumstances any fancy is suspended and does not resume result will be given all previous bets will be valid (based on haar/jeet).
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
    ");
            WriteLiteral(@"            8. Manual bets are not accepted in our exchange
            </label>
            <label class=""red-color"">
            ...
            <label class=""red-color"">
                11. Company reserves the right to void any bets (only winning bets) of any event at any point of the match if the company believes there is ");
            WriteLiteral(@"any cheating/wrong doing in that particular event by the players (either batsman/bowler)
            </label>
            <label class=""red-color"">
            ...
            <label>
                1.2 Session is not completed for ex:- India 60 over run session Ind is running in case India team declares or all-out at 55 over next 5 over session will be continue in England inning.
            </label>
            <label>
            ...
            <label>
                1.4");
            WriteLiteral(@" 1st day 2nd session run minimum 25 over will be played then result is given otherwise 1st day 2nd session will be deleted.
            </label>
            <label>
           ...
           ");
            WriteLiteral(@" <label class=""red-color"">
                3 Test batsman:-
            </label>
            <label>
            ...
            <label>
       ");
            WriteLiteral(@"         4.1 In partnership one batsman is injured partnership is continued in next batsman.
            </label>
            <label>
   ...
   ");
            ...
            <label>
              ");
            WriteLiteral(@"  Advance partnership is valid in case both players are different or same.
            </label>
            <label>
            ...
            WriteLiteral(@"particular session will be deleted.
            </label>
            <label>
            ...
            <label>
                In next men out fancy if player is injured particular fancy will b");
            WriteLiteral(@"e deleted.
            </label>
            <label>
                In advance fancy opening batsmen is only valid if same batsmen came in opening the fancy will be valid in case one batsmen is changed that particular player fancy will be deleted.
            </label>
            ...
            <label>
                If");
            WriteLiteral(@" over reduced due to rain or weather condition or match abandoned the result will be given as per score.
            </label>
            <label class=""red-color"">
                Other fancy:-
            </label>
            ...
            <label>
                1st wicket lost to any team balls meaning that any team 1st wicket fall down in how many balls that particular fancy");
            WriteLiteral(@" at least minimum one ball have to be played otherwise bets will be deleted.
            </label>
            <label>
    ...
    ");
            ...
            <label>
                1. All bets will be considered as valid if a player has been replaced under concussion substitute, result will ");
            WriteLiteral(@"be given for the runs scored by the mentioned player. For example DM Bravo gets retired hurt at 23 runs, then result will be given for 23.
            </label>
            <label>
            ...
            <label>
                This event will be considered valid only if the number of overs defined on the particular event has been bowled, otherwise all bets related to this event will get void. For example 0-25 o");
            WriteLiteral(@"ver events will be valid only if 25 overs has been bowled, else the same will not be considered as valid
            </label>
            <label>
            ...
            <label>
                The mentioned bowler has to complete the defined number of overs, else the bets related to that particular event will ge");
            WriteLiteral(@"t void. For example if the mentioned bowler has bowled 8 overs, then 5 over run of that particular bowler will be considered as valid and the 10 over run will get void
            </label>
            <label class=""red-color"">
            ...
            <label>
                This events will be valid only if the defined number of over is completed. For example team batting first gets all out in 29.4 over then the same will be considere");
            WriteLiteral(@"d as 30 over, the team batting second must complete 20 overs only then 0-50 over events will be considered as valid. In case team batting second gets all out in 19.4 over then 0-50 over event will not be considered as valid, This same is valid for 1st Innings only.
            </label>
            <label class=""red-color"">
                Bowler event- ODI:-
            </label>
            ...
            <label>
                Bowler Session: This event is valid only if the bowler has completed his maximum quota of overs, else the same will be voided. However if the match has resulted and the particular bowler ");
            WriteLiteral(@"has already started bowling his final over then result will be given even if he haven't completed the over. For example B Kumar is bowling his final over and at 3.4 the match has resulted then result will be given for B Kumar over runs
            </label>
            <label>
            ...
            <label class=""red-color"">
                12. Player and partnership are valid only 14 matches.
            </label>
            <label class=""red-color"">
            ...
            <label>
                In case of any technical issues the video gets interrupted/s");
            WriteLiteral(@"topped and the same cannot be continued, the existing markets will be voided. However the markets which are already finished/settled will remain valid.
            </label>
            <label class=""red-color"">
                CPL:-
            </label>
            ...
            <label>
                Total sixes: Average 13 sixes will be given in case match abandoned or");
            WriteLiteral(@" over reduced
            </label>
            <label>
            ...
            <label>
                At any situation if result is given for any particular even");
            WriteLiteral(@"t based on the rates given for the same, then the particular result will be considered valid, similarly if the tournament gets canceled due to any reason the previously given result will be considered valid
            </label>
            <label>
            ...
            <label>
                Highest Sixes in individual match: B");
            WriteLiteral(@"oth innings are valid
            </label>
            <label>
...
<!-- The fancy1MarketModal -->
<div id=""fancy1MarketModal"" class=""modal"">
    <!-- Modal content -->
    <div class=""modal-content"">
        <div class=""modal-header"">
            <span class=""po");
            WriteLiteral(@"pup_close_btn fancy1MarketClose""></span>
            <h3>Rules</h3>
        ...
        <div class=""modal-body"">
            ...
            <label>
                Suppose we have opened value of M Agarwal 3.75 back and customer place bets on 10000 ");
            EndContext();
            BeginContext(44055, 68, true);
            WriteLiteral("@ 3.75 rates and A Rayudu 3.0 back and customer place bets on 10000 ");
            EndContext();
            BeginContext(44124, 14850, true);
            WriteLiteral(@"@ 3.0 rates.
            </label>
            <label>
            ...
            <label>
                1. All bets will be deleted in case the match is a");
            WriteLiteral(@"bandoned or over reduced.
            </label>
            <label>
            ...
            <label>
         ");
            WriteLiteral(@"       All bets will be deleted unless one ball being played by both the mentioned players.
            </label>
            <label>
            ...
            <label>
");
            WriteLiteral(@"                3. Highest run made by the pair will be declared as winner. For example: Opening pair ENG total is 70 runs and Opening pair SA is 90 runs, then SA 90 runs will be declared as winner.
            </label>
            <label>
                Both innings will be valid
            </label>
            ...
            <label>
");
            WriteLiteral(@"                All bets will be deleted if match abandoned or over reduced.
            </label>
            <label>
            ...
            <label>
   ");
            WriteLiteral(@"             All bets will be deleted unless the batsman faces one legal ball.
            </label>
            <label>
                Both Innings will be valid.
            </label>
            ...
            <label>
                1. This is the fancy");
            WriteLiteral(@" for match to be won/ completed in which day & session (Completed: Game has to be completed)
            </label>
            <label>
            ...
            <label>
                Midpoint rule is applicable for test match also. However for lambi meter/ inning meter 70 overs has to be played only then the same ");
            WriteLiteral(@"will be considered as valid
            </label>
            <label class=""red-color"">
                Maximum Boundaries:-
            </label>
...
<!-- The MatchOddsMinMaxModal -->
<div id=""matchOddsMinMaxModal"" class=""popup_window"">
    <button type=""button"" class=""popup_close_btn""></button>
    <div class=""popup_title"">Change Min Max Value</div>
    <div class=""popup_form_fields"">
        <fieldset>
            <div class='form_field'>
          ");
            WriteLiteral(@"      <label>Max Value</label>
                <input type=""text"" id=""txtMatchOddsMax"" />
            </div>
            <div class='form_field'>
                <label>Min Value</label>
                <input type=""text"" id=""txtMatchOddsMin"" />
            </div>
            <div class='form_field' style=""text-align:center;"">
                <button id=""btnSaveMatchOddsMinMax"" class=""btn_field"">Update</button>
            </div>
        </fieldset>
    </div>
</div>

<!-- The BookmakerMarketMinMaxModal -->
<div id=""bookmakerMarketMinMaxModal"" class=""popup_window"">
    <button type=""button"" class=""popup_close_btn""></button>
    <div class=""popup_title"">Change Min Max Value</div>
    <div class=""popup_form_fields"">
        <fieldset>
            <div class='form_field'>
                ...
                <input type=""text"" id=""txtBookmakerMarketMax"" />
            </div>
            <div class='form_field'>
                <label>Min Value</label>
               ");
            WriteLiteral(@" <input type=""text"" id=""txtBookmakerMarketMin"" />
            </div>
            <div class='form_field' style=""text-align:center;"">
                <button id=""btnSaveBookmakerMarketMinMax"" class=""btn_field"">Update</button>
                <button id=""btnRemoveBookmakerMarketMinMax"" class=""btn-danger"">Delete</button>
            </div>
        </fieldset>
    </div>
</div>

<!-- The SessionMarketMinMaxModal -->
<div id=""sessionMarketMinMaxModal"" class=""popup_window"">
    <button type=""button"" class=""popup_close_btn""></button>
    <div class=""popup_title"">Change Min Max Value</div>
    <div class=""popup_form_fields"">
        <fieldset>
            <div class='form_field'>
                <label>Max Value</label>
                <input type=""text"" id=""txtSessionMarketMax"" />
            </div>
            <div class='form_field'>
                <label>Min Value</label>
                <input type=""text"" id=""txtSessionMarketMin"" />
            </div>
            <div class='form_field' ");
            WriteLiteral(@"style=""text-align:center;"">
                <button id=""btnSaveSessionMarketMinMax"" class=""btn_field"">Update</button>
                <button id=""btnRemoveSessionMarketMinMax"" class=""btn-danger"">Delete</button>
            </div>
        </fieldset>
    </div>
</div>

<!-- The Fancy1MarketMinMaxModal -->
<div id=""fancy1MarketMinMaxModal"" class=""popup_window"">
    <button type=""button"" class=""popup_close_btn""></button>
    <div class=""popup_title"">Change Min Max Value</div>
    <div class=""popup_form_fields"">
        <fieldset>
            <div class='form_field'>
                <label>Max Value</label>
                <input type=""text"" id=""txtFancy1MarketMax"" />
            </div>
            <div class='form_field'>
                <label>Min Value</label>
                <input type=""text"" id=""txtFancy1MarketMin"" />
            </div>
            <div class='form_field' style=""text-align:center;"">
                <button id=""btnSaveFancy1MarketMinMax"" class=""btn_field"">Update</butto");
            WriteLiteral(@"n>
                <button id=""btnRemoveFancy1MarketMinMax"" class=""btn-danger"">Delete</button>
...
<!-- The T1PercentageModal -->
<div id=""t1PercentageModal"" class=""popup_window"">
    <button type=""button"" class=""popup_close_btn""></button>
    <div class=""popup_title"">Change T1 Percentage Value</div>
    <div class=""popup_form_fields"">
        <fieldset>
            <div class='form_field'>
                <label>Percentage</label>
                <input type=""number"" min=""0"" max=""100"" id=""txtT1Percentage"" />
            </div>
            <div class='form_field'>
                <label>Team A L1</label>
                <input type=""number"" id=""txtTeamA_L1"" />
            </div>
            <div class='form_field'>
                <label>Team B L1</label>
                <input type=""number"" id=""txtTeamB_L1"" />
            </div>
            <div class='form_field'>
                <label>Team A B1</label>
                <inpu");
            WriteLiteral(@"t type=""number"" id=""txtTeamA_B1"" />
            </div>
            <div class='form_field'>
                <label>Team B B1</label>
                <input type=""number"" id=""txtTeamB_B1"" />
            </div>
            <div class='form_field' style=""text-align:center;"">
                <button id=""btnSaveT1Percentage"" class=""btn_field"">Save</button>
                <button id=""btnRemoveT1Percentage"" class=""btn-danger"">Delete</button>
...
");
            EndContext();
            BeginContext(58974, 81, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dfea12953eca41278618e0796bdac201", async() => {
            }
            );
...
#line 1354 "D:\GitHub\Dream14\Dream14.WebAdmin\Views\Event\EventDetail.cshtml"
